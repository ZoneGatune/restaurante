...
@Component({
  selector: 'app-menu-pollo-brasa',
  templateUrl: './menu-pollo-brasa.component.html',
  styleUrls: ['./menu-pollo-brasa.component.scss'],
  providers: [VentaSeleccionadaService]
})
export class MenuPolloBrasaComponent implements OnInit {
