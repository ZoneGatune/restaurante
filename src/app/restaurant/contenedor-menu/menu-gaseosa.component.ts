...
@Component({
  selector: 'app-menu-gaseosa',
  templateUrl: './menu-gaseosa.component.html',
  styleUrls: ['./menu-gaseosa.component.scss'],
  providers: [VentaSeleccionadaService]
})
export class MenuGaseosaComponent implements OnInit {
