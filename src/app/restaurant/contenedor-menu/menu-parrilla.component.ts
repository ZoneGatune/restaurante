...
@Component({
  selector: 'app-menu-parrilla',
  templateUrl: './menu-parrilla.component.html',
  styleUrls: ['./menu-parrilla.component.scss'],
  providers: [VentaSeleccionadaService]
})
export class MenuParillaComponent implements OnInit {
