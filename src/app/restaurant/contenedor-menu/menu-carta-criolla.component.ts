...
@Component({
  selector: 'app-menu-carta-criolla',
  templateUrl: './menu-carta-criolla.component.html',
  styleUrls: ['./menu-carta-criolla.component.scss'],
  providers: [VentaSeleccionadaService]
})
export class MenuCartaCriollaComponent implements OnInit {
