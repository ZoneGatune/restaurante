...
@Component({
  selector: 'app-barban',
  templateUrl: './barban.component.html',
  styleUrls: ['./barban.component.scss']
})
export class BarbanComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    x.snapshotChanges().subscribe(item => {
      ...
      this.menuList = this.menuList.filter( x => x.codigoCategoria === '31');
    });
  ...
  onSubmit(menuForm: NgForm) {
    ...
    this.menu.codigoCategoria = '31';
    this.menu.categoria = 'Barban';
    this.menu.descripcion = 'bar tender';
    ...
    this.tostr.success('Submitted Succcessfully', 'Bar Register');
  }
